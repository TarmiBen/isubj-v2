...
class CalendarReservations extends Page
{
    ...
    public function loadReservations(): void
    {
        ...
        $monthReservations = Reservation::with(['user', 'agenda'])
        ...
        $this->upcomingReservations = Reservation::with(['user', 'agenda'])
            ->whereDate('date', '>=', now())
        ...
        $this->pastReservations = Reservation::with(['user', 'agenda'])
