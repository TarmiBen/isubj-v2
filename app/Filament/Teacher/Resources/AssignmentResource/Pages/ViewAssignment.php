...
use App\Filament\Exports\TestAttendanceExport;
...
class ViewAssignment extends ViewRecord
{
    ...
    protected static string $view = 'filament.teacher.resources.assignment-resource.pages.view-assignment';
    ...
    {
        return 'Detalle: ' . $this->record->subject->name;
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
           ...
           Action::make('viewDocuments')
                ...
                ->color('info')
                ->url(fn (Assignment $record): string => ViewAssignmentDetails::getUrl(['record' => $record])),
        ];
    }
                                                    ...
                                                    ->action(function (array $data, $record) {
                                                        ...
                                                        try {
                                                            DB::transaction(function () use ($filePath, $fullPath, $record) {
                                                                ...
                                                                // E9 -> fila 9 (índice 8), columna E (índice 4)
                                                            ...
                                                            Notification::make()
                                                                ...
                                                                ->body('El archivo fue validado y las calificaciones fueron procesadas exitosamente.')
                                                                ->success()
                                                                ->send();
