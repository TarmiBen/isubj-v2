...
class CyclePolicy
{
     ...
     */
    public function view(User $user, Cycle $model): bool
    {
     ...
     */
    public function update(User $user, Cycle $model): bool
    {
     ...
     */
    public function delete(User $user, Cycle $model): bool
    {
     ...
     */
    public function forceDelete(User $user, Cycle $model): bool
    {
     ...
     */
    public function restore(User $user, Cycle $model): bool
    {
     ...
     */
    public function replicate(User $user, Cycle $model): bool
    {
