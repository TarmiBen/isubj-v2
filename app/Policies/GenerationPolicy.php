...
class GenerationPolicy
{
    ...
    {
        return $user->can('delete_any_generation');
    }
    ...
    {
        return $user->can('force_delete_any_generation');
    }
    ...
    {
        return $user->can('restore_any_generation');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Generation $generation): bool
    {
        return $user->can('replicate_generation');
    }
    ...
    {
        return $user->can('reorder_generation');
    }
}
